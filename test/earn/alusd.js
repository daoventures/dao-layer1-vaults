...
describe("DAO Earn", () => {
    ...
    beforeEach(async () => {
        await deployments.fixture(["earn_mainnet_deploy_vault_alusd"])
    })
    ...
    it("Should work", async () => {
        ...
        // Deposit
        console.log("LP token Deposit:", ethers.utils.formatEther(await lpTokenContract.balanceOf(client.address)))
