...
describe("DAO Earn", () => {
    ...
    beforeEach(async () => {
        await deployments.fixture(["earn_mainnet_deploy_vault_hbtc"])
    })

    it("Should work", async () => {
        const [deployer, client, strategist, biconomy, treasury, community] = await ethers.getSigners()
        const curveZap = await ethers.getContract("CurveHBTCZap")
        ...
        await lpTokenContract.transfer(sample.address, ethers.utils.parseEther("2"))
