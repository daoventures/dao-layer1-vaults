...
const unlockedAddress = "0x6653d30d9aa30843e13d01e29d21a456ba15b09d"//"0xc247722Ac42B2f9BA752886502c3D3dD39BDb2Da"//addresses.ADDRESSES.unlockedUser
const unlockedAddress2 = "0xb690277c09bcbe8354974cb75d1abc42581cf94a" //"0xF39d30Fa570db7940e5b3A3e42694665A1449E4B"//addresses.ADDRESSES.unlockedUser2


describe("Mirror - mBABA-UST", () => {
    const setup = async () => {
        const [deployer, user1, user2, topup] = await ethers.getSigners()

        const lpToken = new ethers.Contract(addresses.LPTOKENS.mBABA_UST, IERC20_ABI, deployer)
        ...
        await lpToken.connect(unlockedUser2).transfer(user2.address, ethers.utils.parseUnits("0.8", "18"))
    ...
    beforeEach(async () => {
        await deployments.fixture(["mirror_mainnet_deploy_pool_mbaba_ust"])
    })
