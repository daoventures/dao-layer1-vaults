...
const unlockedAddress = "0x0c722f3dcf2bebb50fcca45cd6715ee31a2ad793"//"0xc247722Ac42B2f9BA752886502c3D3dD39BDb2Da"//addresses.ADDRESSES.unlockedUser
const unlockedAddress2 = "0x8471f499dec9b270dc05516f18cf338d47b1775a" //"0xF39d30Fa570db7940e5b3A3e42694665A1449E4B"//addresses.ADDRESSES.unlockedUser2


describe("Mirror - mAAPL-UST", () => {
    const setup = async () => {
        const [deployer, user1, user2, topup] = await ethers.getSigners()

        const lpToken = new ethers.Contract(addresses.LPTOKENS.mAAPL_UST, IERC20_ABI, deployer)
    ...
    beforeEach(async () => {
        await deployments.fixture(["mirror_mainnet_deploy_pool_maapl_ust"])
    })
