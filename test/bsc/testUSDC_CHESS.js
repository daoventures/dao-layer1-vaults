...
const unlockedAddress = "0x1f199adfec9c450f676ce1adbc0882f4270f457a"
const unlockedAddress2 = "0x788b3a68329eaf8cd97b0e3e47c1c837233c85c4"


describe("BSC - USDC_CHESS", () => {
    const setup = async () => {
        const [deployer, user1, user2, topup] = await ethers.getSigners()

        const lpToken = new ethers.Contract(addresses.LPTOKENS.USDC_CHESS, IERC20_ABI, deployer)
    ...
    beforeEach(async () => {
        await deployments.fixture(["bsc_mainnet_deploy_pool_usdc_chess"])
    })
