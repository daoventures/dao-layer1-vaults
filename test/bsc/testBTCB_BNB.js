...
const unlockedAddress2 = "0xd38a82102951b82ab7884e64552538fbfe701bad"
...
describe("BSC - BTCB-BNB", () => {
    const setup = async () => {
        ...
        const lpToken = new ethers.Contract(addresses.LPTOKENS.BTCB_BNB, IERC20_ABI, deployer)
    ...
    beforeEach(async () => {
        await deployments.fixture(["bsc_mainnet_deploy_pool_btcb_bnb"])
    })
