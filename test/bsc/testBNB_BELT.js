...
const unlockedAddress = "0xa6565ab230388c7dd7eee9b8a803fa9601cceef2"
const unlockedAddress2 = "0x656b6c931a70c8c4dd69dd48ba8e2971ea96fdae"


describe("BSC - BNB-BELT", () => {
    const setup = async () => {
        const [deployer, user1, user2, topup] = await ethers.getSigners()

        const lpToken = new ethers.Contract(addresses.LPTOKENS.BNB_BELT, IERC20_ABI, deployer)
    ...
    beforeEach(async () => {
        await deployments.fixture(["bsc_mainnet_deploy_pool_bnb_belt"])
    })
