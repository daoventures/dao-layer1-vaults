...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHUSDC", "daoETHUSDC",
        network_.MIRROR.mMSFT_UST_POOL, network_.TOKENS.mMSFT, network_.LPTOKENS.mMSFT_UST,
    ...
    console.log("mMSFT_UST Proxy :", vaultProxyAddress);


};

module.exports.tags = ["mirror_mainnet_deploy_pool_mmsft_ust"];
