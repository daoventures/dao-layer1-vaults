...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHUSDC", "daoETHUSDC",
        network_.MIRROR.mQQQ_UST_POOL, network_.TOKENS.mQQQ, network_.LPTOKENS.mQQQ_UST,
    ...
    console.log("mQQQ_UST Proxy :", vaultProxyAddress);


};

module.exports.tags = ["mirror_mainnet_deploy_pool_mqqq_ust"];
