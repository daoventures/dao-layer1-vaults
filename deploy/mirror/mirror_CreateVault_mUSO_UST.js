...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHUSDC", "daoETHUSDC",
        network_.MIRROR.mUSO_UST_POOL, network_.TOKENS.mUSO, network_.LPTOKENS.mUSO_UST,
    ...
    console.log("mUSO_UST Proxy :", vaultProxyAddress);


};

module.exports.tags = ["mirror_mainnet_deploy_pool_muso_ust"];
