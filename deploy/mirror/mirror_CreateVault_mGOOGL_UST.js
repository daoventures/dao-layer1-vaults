...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHUSDC", "daoETHUSDC",
        network_.MIRROR.mGOOGL_UST_POOL, network_.TOKENS.mGOOGL, network_.LPTOKENS.mGOOGL_UST,
    ...
    console.log("mGOOGL_UST Proxy :", vaultProxyAddress);


};

module.exports.tags = ["mirror_mainnet_deploy_pool_mgoogl_ust"];
