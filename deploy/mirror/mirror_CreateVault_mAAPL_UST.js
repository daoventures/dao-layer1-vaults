...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHUSDC", "daoETHUSDC",
        network_.MIRROR.mAAPL_UST_POOL, network_.TOKENS.mAAPL, network_.LPTOKENS.mAAPL_UST,
    ...
    console.log("mAPPL_UST Proxy :", vaultProxyAddress);


};

module.exports.tags = ["mirror_mainnet_deploy_pool_maapl_ust"];
