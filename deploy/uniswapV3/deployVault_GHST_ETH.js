...
const { mainnet: network_ } = require('../../addresses/uniswapV3');
...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", [network_.TOKENS.GHST, network_.TOKENS.WETH, network_.TOKENS.ETH_GHST_LP,
        network_.ADDRESSES.adminAddress, network_.ADDRESSES.communityWallet, network_.ADDRESSES.treasuryWallet, network_.ADDRESSES.strategist, 
        10000, -840000, 840000])
