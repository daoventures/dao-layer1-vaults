...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAOVaultETHAXS", "daoETHAXS", network_.poolIDs.ETHAXS,
        network_.TOKENS.WETH, network_.TOKENS.AXS, network_.TOKENS.ETHAXSLP,
...
module.exports.tags = ["oa_mainnet_deploy_pool_eth-axs"];
