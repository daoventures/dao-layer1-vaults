...
module.exports = async ({ deployments }) => {
    ...
    let data = implInterfacec.encodeFunctionData("initialize", ["DAO L1 pnck bnb-belt", "daopnckBNB_BELT",
    ...
    console.log("bnb-belt Proxy :", vaultProxyAddress);


};

module.exports.tags = ["bsc_mainnet_deploy_pool_bnb_belt"];
